...
var gls = [[['位移'], [['崖心', 5], ['阿消', 4], ['暗索', 4], ['可颂', 5], ['食铁兽', 5]]], [['削弱'], [['初雪', 5], ['陨星', 5], ['夜烟', 4], ['拉普兰德', 5], ['流星', 4]]], [['召唤'], [['梅尔', 5], ['深海色', 4]]], [['快速复活'], [['砾', 4], ['红', 5]]], [['控场'], [['红', 5], ['梅尔', 5], ['德克萨斯', 5], ['天火', 5]]], [['支援'], [['白面鸮', 5], ['凛冬', 5], ['华法琳', 5], ['空', 5], ['Castle-3', 1], ['杜宾', 4]]], [['爆发'], [['守林人', 5], ['暴行', 5]]], [['特种干员'], [['崖心', 5], ['阿消', 4], ['砾', 4], ['红', 5], ['暗索', 4], ['狮蝎', 5], ['食铁兽', 5]]], [['减速', '狙击干员'], [['白雪', 4]]], [['减速', '群攻'], [['白雪', 4]]], [['减速', '输出'], [['真理', 5], ['霜叶', 4]]], [['减速', '近卫干员'], [['霜叶', 4]]], [['减速', '近战位'], [['霜叶', 4], ['食铁兽', 5]]], [['治疗', '辅助干员'], [['空', 5]]], [['治疗', '近战位'], [['古米', 4], ['临光', 5]]], [['治疗', '重装干员'], [['古米', 4], ['临光', 5]]], [['治疗', '防护'], [['古米', 4], ['临光', 5]]], [['狙击', '生存'], [['杰西卡', 4]]], [['狙击', '群攻'], [['陨星', 5], ['白雪', 4]]], [['生存', '群攻'], [['幽灵鲨', 5], ['艾丝黛尔', 4]]], [['生存', '远程位'], [['杰西卡', 4]]], [['生存', '重装干员'], [['火神', 5]]], [['生存', '防护'], [['火神', 5]]], [['男', '近卫干员'], [['Castle-3', 1]]], [['男', '防护'], [['角峰', 4]]], [['群攻', '近卫干员'], [['幽灵鲨', 5], ['暴行', 5], ['艾丝黛尔', 4]]], [['群攻', '近战位'], [['幽灵鲨', 5], ['暴行', 5], ['艾丝黛尔', 4]]], [['辅助', '输出'], [['真理', 5]]], [['输出', '重装干员'], [['火神', 5], ['雷蛇', 5]]], [['输出', '防护'], [['火神', 5], ['雷蛇', 5]]], [['女', '术士干员', '输出'], [['夜烟', 4]]]];
	...
	require([], function () {
		var App = function (_React$Component) {
			...
			function App(props) {
				...
				_this.state = {
					btnls: [['男', false], ['女', false], ['远程位', false], ['近战位', false], ['近卫干员', false], ['术士干员', false], ['先锋干员', false], ['医疗干员', false], ['特种干员', false], ['重装干员', false], ['新手', false], ['召唤', false], ['削弱', false], ['防护', false], ['爆发', false], ['快速复活', false], ['辅助', false], ['生存', false], ['费用回复', false], ['治疗', false], ['群攻', false], ['输出', false], ['减速', false], ['位移', false], ['狙击', false], ['支援', false], ['控场', false]],
					res: []
				};
				return _this;
			}
